...
public:
	...
	void GatherObjectsHitByChannel(sf::IntRect rect, NameHash channelName, ObjectRefList& gatherList) const;
	void GatherObjectsHitByChannel(sf::IntRect rect, NameHash channelName, ObjectConstRefList& gatherList) const;

	ObjectRef FindFirstHitByChannel(sf::IntRect rect, NameHash channelName, GameObject* ignore = nullptr) const;
